        ...
        <div className='max-w-[470px] h-max'>
            ...
            <div className='w-full mt-3 flex justify-between items-center max-sm:px-3'>
                <div className='flex items-center gap-2'>
                    {
                        isActiveStory ? (
                            <div style={{ padding: '2px' }} className='select-none flex justify-center items-center bg-gradient-to-r from-fuchsia-400 from-10% via-amber-400 via-30% to-rose-400 to-90% rounded-full hover:cursor-pointer'>
